...
export default function Footer() {
    return (
        <div className="px-4 py-6 text-s text-gray-700" style={{background: '#F4E7E7'}}>
            <div className="grid grid-nogutter md:grid-cols-4 gap-4 align-items-center justify-content-between text-center">
            ...
            <div className="text-center ml-8">Powered By EVER EFFICIANT Business Management (Pvt) Ltd</div>
        </div>
    );
}